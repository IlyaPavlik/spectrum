...
class ColorNameConverter : BaseConverter<ColorName, ColorInfoEntity>() {
    ...
    override fun convertToEntity(dto: ColorName): ColorInfoEntity = ColorInfoEntity(dto.hex, dto.name)

    override fun convertToDto(entity: ColorInfoEntity): ColorName = ColorName(entity.id, entity.name)
